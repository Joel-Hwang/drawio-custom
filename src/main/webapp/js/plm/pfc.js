...
window.onload = function () {
    ...
    window.addEventListener("message", postMessagePfc);
    iframe.setAttribute(
        "src",
        drawUrl +
        "/?splash=0&clibs=U"+encodeURIComponent(drawUrl+'/stencils/pfc/PFC')+"&embed=1&ui=sketch&spin=1&proto=json&configure=1&ruler=1&zoom=4&viewbox=" +
